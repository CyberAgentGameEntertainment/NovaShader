Shader "Hidden/Nova/Particles/UberUnlit(Optimized Transparent DepthOnly DepthNormals ShadowCaster)"
{
    Properties
    {
        // Render Settings
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "..\Nova\Runtime\Core\Shaders/ParticlesUberUnlitForward.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "..\Nova\Runtime\Core\Shaders/ParticlesUberUnlitEditor.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "..\Nova\Runtime\Core\Shaders/ParticlesUberDepthNormals.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "..\Nova\Runtime\Core\Shaders/ParticlesUberDepthOnly.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "..\Nova\Runtime\Core\Shaders/ParticlesUberShadowCaster.hlsl"
            ENDHLSL
        }
    }
