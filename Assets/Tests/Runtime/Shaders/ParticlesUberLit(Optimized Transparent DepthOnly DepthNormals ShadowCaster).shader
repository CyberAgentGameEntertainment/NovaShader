Shader "Hidden/Nova/Particles/UberLit(Optimized Transparent DepthOnly DepthNormals ShadowCaster)"
{
    Properties
    {
        // Render Settings
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "..\Nova\Runtime\Core\Shaders/ParticlesUberLitForward.hlsl"
            ENDHLSL
        }
